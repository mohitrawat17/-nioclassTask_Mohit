    ...
    <MathJaxContext config={config}>
      <div className="py-8 my-16">
        <div className="w-full h-full mx-auto bg-white p-6 rounded shadow-lg">
          ...
          <div className="mb-4">
            <p className="text-lg font-semibold overflow-x-scroll">
          ...
          <div className="flex max-sm:flex-col-reverse justify-between mb-4">
            <p className="text-red-600 max-sm:mt-4">
              * If it is the last question then click on submit test
            </p>
            <Link
              to="/finish"
              className="max-sm:px-2 max-sm:py-1 bg-red-700 max-sm:w-[105px] text-white px-4 py-2 rounded"
